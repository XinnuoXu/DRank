...
def preprocess_opts(parser):
    ...
    group.add_argument('-pre_train', action='store_true',
                       help="Whether it's pre train")
    group.add_argument('-extra_vocab', default="",
                       help="Path to the extra dictionary")
...
def translate_opts(parser):
    ...
    group.add_argument('-beam_sample', action="store_true",
                       help="""Do sampling instead of gready searching""")
