...
class BeliefTrackingManager(object):
    ...
    def __init__(self):
        ...
        self.domainBeliefTrackers = {}
        for ky in OntologyUtils.available_domains:
            self.domainBeliefTrackers[ky] = None
    ...
    def _load_domains_belieftracker(self, domainString=None):
        ...
        if belief_type == 'focus':
            ...
            from belieftracking.baseline import BaselineTracker
