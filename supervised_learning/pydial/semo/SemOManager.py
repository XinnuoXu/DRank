    ...
    def _load_domains_semo(self, dstring):
        ...
        if semo_type == 'PassthroughSemO':
            ...
            if dstring == 'topicmanager':
                ...
                from semo.RNNSemOMethods import RNNSemO
