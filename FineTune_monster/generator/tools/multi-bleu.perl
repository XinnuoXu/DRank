...
my $b4 = 100 * $brevity_penalty * exp((my_log($bleu[1]) + my_log($bleu[2]) + my_log($bleu[3]) + my_log($bleu[4])) / 4);
my $b3 = 100 *$brevity_penalty * exp((my_log($bleu[1]) + my_log($bleu[2]) + my_log($bleu[3])) / 3);
my $b2 = 100 *$brevity_penalty * exp((my_log($bleu[1]) + my_log($bleu[2])) / 2);
my $b1 = 100 * $brevity_penalty * exp(my_log($bleu[1]));
printf "BLEU-1-2-3-4  = %.2f %.2f %.2f %.2f\n", $b1, $b2, $b3, $b4;
