...
python predictor_coherence_interactive.py -model trained_models.$3/hierarchical_coherence_attention/model.tar.gz -test_pos $1 -test_neg $2 | grep RES > test.res
