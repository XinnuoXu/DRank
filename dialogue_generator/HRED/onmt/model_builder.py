...
def build_base_model(model_opt, fields, gpu, checkpoint=None):
    ...
    if model_opt.model_type == "text":
        ...
        sen_seg = src_dict.stoi['<s>'] # @HRED
        pad_idx = src_dict.stoi[inputters.PAD_WORD] # @HRED
        feature_dicts = inputters.collect_feature_vocabs(fields, 'src')
        src_embeddings = build_embeddings(model_opt, src_dict, feature_dicts)
        encoder, sen_encoder = build_encoder(model_opt, src_embeddings)
    ...
    model = onmt.models.NMTModel(encoder, decoder, sen_encoder, sen_seg = sen_seg, pad_idx = pad_idx, gpu = gpu)
